...
class Test_to_you:
    ...
    def ceh(self):
        ...
        self.numero_preguntas_examen = 125
        self.fichero= "questions-ceh.json"
        self.leer_fichero()
        self.elegir_nuemero_preguntas()
    ...
    def lpic1(self):
        ...
        self.fichero= "questions-lpic1-101.json"
        self.leer_fichero()
        self.elegir_nuemero_preguntas()
    ...
    def corregir(self): 
        if self.respuesta_usuario == self.respuesta_correcta:
            ...
            self.agregar_linea_a_archivo(f"{self.pregunta_actual + 1} - {self.respuesta_usuario} - Incorrecto\n")
    ...
    def interfaz_nota(self):
        ...
        self.json_preguntas['nombre'] == "CEH":
            if self.nota >= self.numero_preguntas_examen*0.70:
                estado = "PASSED"
            else:
                estado = "FAILED"
